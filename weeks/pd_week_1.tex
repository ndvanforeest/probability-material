...
(In the above queueing model, there are 5 arrivals per day, hence \(m=5n\).) We are interested in the distribution of the number of arrivals on som given day $j$, when $n$ is large.
