...
\begin{exercise}
Changing the value of the variable \verb|end| to 100 in the code above, and run it again. Then change it to 50.  When I do this, I get a very strange answer for 50. Try to explain what goes wrong. (In python you can also try the value 1000; then the answer is also not correct. R doesn't seem to give an answer at all.)
\end{exercise}
